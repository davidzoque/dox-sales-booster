...
* **Changed: the popup sample cities now follow your store country** (WooCommerce → Settings → General) instead of the site language, with lists for Colombia, the United States, Mexico, Spain, Argentina, Chile, Peru, Brazil, Canada and the United Kingdom. A store in Spain was getting Colombian cities and a store in Portugal American ones, because the language of a site says nothing about where it sells. If there is no list for your country the field starts empty and the popup simply shows the time without a city, which beats inventing a city on the other side of the world.
* Fixed: emptying the city list fell back to five hardcoded Colombian cities.
